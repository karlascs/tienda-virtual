            ...
            {!loading && !error && (
              <div style={{
                ...
                <span style={{
                  ...
                  {filteredProducts.length === actividadProducts.length ? (
                    `${actividadProducts.length} producto${actividadProducts.length !== 1 ? 's' : ''}`
                  ) : (
                    <>
                      {actividadProducts.length} producto{actividadProducts.length !== 1 ? 's' : ''} disponible{actividadProducts.length !== 1 ? 's' : ''}
